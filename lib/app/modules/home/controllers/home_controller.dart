...
class HomeController extends GetxController {
  ...
  final DatabaseReference historyMakan =
      FirebaseDatabase.instance.ref('AlatMakan/History/');

  final DatabaseReference wadah =
      FirebaseDatabase.instance.ref('AlatMakan/LevelWadah');
  final DatabaseReference timbangan =
      FirebaseDatabase.instance.ref('AlatMakan/Timbangan');

  final DatabaseReference getSet1 =
      FirebaseDatabase.instance.ref('AlatMakan/SetWaktu/');
